      ...
      <WhySortedStyles>
        ...
        <div className="why__wrapper">
          <h2>
            ...
            management and letting experience, Sorted has first-hand knowledge
            of the frustrations faced by property managers. We know property
            maintenance inside out, which not only enables us to fully
            understand what you want, but also allows us to provide everything
          ...
          <p>
            ...
            objective? To provide a hassle-free, high quality property
            maintenance service, with seamless communication at its core. With a
            team who have been where you are today.
          </p>
        </div>
        <div className="why__team">
          <div className="why__team__wrapper">
            <h2>Our operatives </h2>
            <p>
              The Sorted workforce is comprised of professional and
              highly-skilled individuals, fully equipped and qualified to deal
              with your needs, wants and frustrations as a property manager.
              Friendly and always happy to help, each operative is accredited in
              their field of expertise and guaranteed to get the job done to
              outstanding standards. Plus, they’re all covered by our full
              Public Liability insurance, so you are in safe hands, whether you
              need repairs, replacements or even a full upgrade.
            </p>
            <p>
